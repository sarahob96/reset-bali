...
urlpatterns = [
    ...
    path('update_renew_booking/<booking_id>', views.update_renew_booking, name= "update_renew_booking"),
    path('update_restart_booking/<booking_id>', views.update_restart_booking, name= "update_restart_booking"),
